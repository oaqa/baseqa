...
public class EntitySearchResult_Type extends AnswerSearchResult_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.retrieval.EntitySearchResult");
  ...
  public int getEntities(int addr) {
      ...
      jcas.throwFeatMissing("entities", "org.oaqa.model.retrieval.EntitySearchResult");
