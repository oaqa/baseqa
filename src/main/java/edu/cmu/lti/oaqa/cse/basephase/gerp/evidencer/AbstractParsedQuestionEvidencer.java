...
public abstract class AbstractParsedQuestionEvidencer extends
	  ...
	  public void evidenceCandidates(JCas jcas) throws AnalysisEngineProcessException {
	    ...
	    // do task
	    evidenceParsedQuestions(question, placeholders);
	    // save output
	    try {
	  ...
	  protected abstract void evidenceParsedQuestions(final String question, List<PlaceHolder> keyterms)
