...
public abstract class AbstractAnswerCandidateRanker extends
	...
	public void rankCandidates(JCas jcas) throws AnalysisEngineProcessException {
		...
		// do task
		rankAnswerCandidates(question, placeholders);
		// save output
		try {
	...
	protected abstract void rankAnswerCandidates(final String question,
			List<PlaceHolder> placeholders)
