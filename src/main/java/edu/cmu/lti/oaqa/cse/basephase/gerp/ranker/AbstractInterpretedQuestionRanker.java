...
public abstract class AbstractInterpretedQuestionRanker extends
	...
	public void rankCandidates(JCas jcas) throws AnalysisEngineProcessException {
		...
		// do task
		rankInterpretedQuestions(question, placeholders);
		// save output
		try {
	...
	protected abstract void rankInterpretedQuestions(final String question,
			List<PlaceHolder> placeholders)
