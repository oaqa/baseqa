...
public abstract class AbstractGatheredEvidencePruner extends
	...
	public void pruneCandidates(JCas jcas)
		...
		// do task
		pruneGatheredEvidences(question, placeholders);
		// save output
		PlaceHolderList.storePlaceHolders(jcas, placeholders, true);
	}

	protected abstract void pruneGatheredEvidences(final String question,
