...
public abstract class AbstractRankedAnswerEvidencer extends
	  ...
	  public void evidenceCandidates(JCas jcas) throws AnalysisEngineProcessException {
	    ...
	    // do task
	    evidenceRankedAnswers(question, placeholders);
	    // save output
	    try {
	  ...
	  protected abstract void evidenceRankedAnswers(final String question, List<PlaceHolder> placeholders)
