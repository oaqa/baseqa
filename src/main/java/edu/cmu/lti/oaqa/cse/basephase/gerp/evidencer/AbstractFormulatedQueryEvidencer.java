...
public abstract class AbstractFormulatedQueryEvidencer extends AbstractCandidateEvidencer {
	  ...
	  public void evidenceCandidates(JCas jcas) throws AnalysisEngineProcessException {
	    ...
	    // do task
	    evidenceFormulatedQueries(question, placeholders);
	    // save output
	    try {
	  ...
	  protected abstract void evidenceFormulatedQueries(final String question, List<PlaceHolder> placeholders)
