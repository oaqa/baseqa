...
public abstract class AbstractInterpretedQuestionPruner extends
	...
	public void pruneCandidates(JCas jcas)
		...
		// do task
		pruneInterpretedQuestions(question, placeholders);
		// save output
		PlaceHolderList.storePlaceHolders(jcas, placeholders, true);
	}

	protected abstract void pruneInterpretedQuestions(final String question,
