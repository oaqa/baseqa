...
public abstract class AbstractParsedQuestionPruner extends
	...
	public void pruneCandidates(JCas jcas)
		...
		// do task
		pruneParsedQuestions(question, placeholders);
		// save output
		PlaceHolderList.storePlaceHolders(jcas, placeholders, true);
	}

	protected abstract void pruneParsedQuestions(final String question,
