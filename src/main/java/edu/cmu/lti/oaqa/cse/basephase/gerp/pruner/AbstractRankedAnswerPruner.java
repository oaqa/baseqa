...
public abstract class AbstractRankedAnswerPruner extends
	...
	public void pruneCandidates(JCas jcas)
		...
		// do task
		pruneRankedAnswers(question, placeholders);
		// save output
		PlaceHolderList.storePlaceHolders(jcas, placeholders, true);
	}

	protected abstract void pruneRankedAnswers(final String question,
