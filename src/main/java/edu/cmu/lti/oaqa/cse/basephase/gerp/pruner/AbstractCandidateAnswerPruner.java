...
public abstract class AbstractCandidateAnswerPruner extends
	...
	public void pruneCandidates(JCas jcas)
		...
		// do task
		pruneAnswerCandidates(question, placeholders);
		// save output
		PlaceHolderList.storePlaceHolders(jcas, placeholders, true);
	}

	protected abstract void pruneAnswerCandidates(final String question,
