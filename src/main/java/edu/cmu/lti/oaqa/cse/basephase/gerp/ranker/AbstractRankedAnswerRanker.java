...
public abstract class AbstractRankedAnswerRanker extends
	...
	public void rankCandidates(JCas jcas) throws AnalysisEngineProcessException {
		...
		// do task
		rankRankedAnswers(question, placeholders);
		// save output
		try {
	...
	protected abstract void rankRankedAnswers(final String question,
			List<PlaceHolder> placeholders)
