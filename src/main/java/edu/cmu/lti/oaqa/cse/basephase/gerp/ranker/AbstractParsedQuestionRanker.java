...
public abstract class AbstractParsedQuestionRanker extends
	...
	public void rankCandidates(JCas jcas) throws AnalysisEngineProcessException {
		...
		// do task
		rankParsedQuestions(question, placeholders);
		// save output
		try {
	...
	protected abstract void rankParsedQuestions(final String question,
			List<PlaceHolder> placeholders)
