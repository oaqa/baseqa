...
public abstract class AbstractGatheredEvidenceEvidencer extends
	  ...
	  public void evidenceCandidates(JCas jcas) throws AnalysisEngineProcessException {
	    ...
	    // do task
	    evidenceGatheredEvidences(question, placeholders);
	    // save output
	    try {
	  ...
	  protected abstract void evidenceGatheredEvidences(final String question, List<PlaceHolder> placeholders)
