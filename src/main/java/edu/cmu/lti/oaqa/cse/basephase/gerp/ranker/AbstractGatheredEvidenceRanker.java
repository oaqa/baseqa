...
public abstract class AbstractGatheredEvidenceRanker extends
	...
	public void rankCandidates(JCas jcas) throws AnalysisEngineProcessException {
		...
		// do task
		rankGatheredEvidences(question, placeholders);
		// save output
		try {
	...
	protected abstract void rankGatheredEvidences(final String question,
			List<PlaceHolder> placeholders)
