...
public class AbstractQuery extends TOP {
  ...
  /** getter for concepts - gets The list of query concepts that make up this
            abstract query. The list is ordered.
   * @generated
  ...
  /** setter for concepts - sets The list of query concepts that make up this
            abstract query. The list is ordered. 
   * @generated
