...
public class AnswerGoldStandardDecorator extends JCasAnnotator_ImplBase {
  ...
  public void process(JCas aJCas) throws AnalysisEngineProcessException {
    try {
      ...
      List<AnswerList> gsAnnotations = (List<AnswerList>) persistence.populateRetrievalGS(dataset,
              sequenceId, gsView);
